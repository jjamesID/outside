...
if turn == True:
    if turns == 1:
        ...
        if outlet[0] == True:
            ...
            with colo1:
                ot1 = st.number_input('', min_value = 1, max_value = 480, label_visibility='hidden',  key = 'ot1')
            with colo2:
                ot2 = st.number_input('', min_value = 1, max_value = 480, label_visibility='hidden',  key = 'ot2')
            outTurn.append(ot0)
            outTurn.append(ot1)
            outTurn.append(ot2)
    elif turns == 3:
        ...
        if outlet[0] == True:
            ...
            with colo0:
                ot0 = st.number_input('Enter number of outlets:', min_value = 1, max_value = 480, key = 'ot0')
                ot2 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot2')
            with colo1:
                ot1 = st.number_input('', min_value = 1, max_value = 480, label_visibility='hidden',  key = 'ot1')
                ot3 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot3')
            outTurn.append(ot0)
            outTurn.append(ot1)
            outTurn.append(ot2)
            outTurn.append(ot3)
        ...
        if outlet[0] == True:
            ...
            with colo0:
                ot0 = st.number_input('Enter number of outlets:', min_value = 1, max_value = 480, key = 'ot0')
                ot2 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot2')
                ot4 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot4')
            with colo1:
                ot1 = st.number_input('', min_value = 1, max_value = 480, label_visibility='hidden',  key = 'ot1')
                ot3 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot3')
            outTurn.append(ot0)
        ...
        if outlet[0] == True:
            ...
            with colo1:
                ot1 = st.number_input('', min_value = 1, max_value = 480, label_visibility='hidden',  key = 'ot1')
                ot3 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot3')
                ot5 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot5')
            outTurn.append(ot0)
            outTurn.append(ot1)
            outTurn.append(ot2)
            outTurn.append(ot3)
        ...
        if outlet[0] == True:
            ...
            with colo0:
                ...
                ot2 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot2')
                ot4 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot4')
                ot6 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot6')
            with colo1:
                ot1 = st.number_input('', min_value = 1, max_value = 480, label_visibility='hidden',  key = 'ot1')
                ot3 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot3')
                ot5 = st.number_input('', min_value = 1, max_value = 480, label_visibility='collapsed',  key = 'ot5')
    ...
    if outlet[0] == True:
        ...
        outTurn.append(ot0)
    straight = True
fin = st.selectbox("Select Finish:", ('SS', 'PS', 'BK', 'ORB', 'BK', 'SPF'), key = 'fin')
    ...
    if (mod == "S-AG 38") or (mod == "S-DG 38") or (mod == "S-LAG 38") or (mod == "S-LT 38") or (mod == "S-AG 65") or (mod == "S-DG 65") or (mod == "S-TIF 65") or (mod == "S-LAG 65") or (mod == "S-LT 65") or (mod == "S-LTIF 65") or (mod == "S-DG 65") or (mod == "S-AG 100") or (mod == "S-AS 65") or (mod == "S-AS 99") or (mod == "S-LTIFAS 65") or (mod == "S-LTIFAS 99") or (mod == "S-TIFAS 65") or (mod == "S-TIFAS 99"):
        ...
        if leng > 192:
            ...
            if (mod == "S-LTIF 65") or (mod == "S-LTIFAS 65") or (mod == "S-LTIFAS 99"):
                ...
                quantity(grt + str(samplist[1]) +" "+ str(fin), samplist[0])
                quantity(grt + str(samplist[2]) +" "+ str(fin), 1)
                if (mod == "S-LTIFAS 65") or (mod == "S-LTIFAS 99"):
                    for i in range(0,samplist[0] * 2):
                        comp2.append("CT "+ str(samplist[1]) + " " + str(fin))
                    for i in range(0,2):
                        comp2.append("CT "+ str(samplist[2]) + " " + str(fin))
            ...
            if (mod == "S-TIF 65") or (mod == "S-TIFAS 65") or (mod == "S-TIFAS 99"):
                ...
                quantity(grt + str(samplist[1]) +" "+ str(fin), samplist[0])
                quantity(grt + str(samplist[2]) +" "+ str(fin), 1)
                if (mod == "S-TIFAS 65") or (mod == "S-TIFAS 99"):
                    for i in range(0,samplist[0] * 2):
                        comp2.append("CT "+ str(samplist[1]) + " " + str(fin))
                    for i in range(0,2):
                        comp2.append("CT "+ str(samplist[2]) + " " + str(fin))
...
if submitted:
    ...
    if turn == True:
        ...
        f0 = ssc(mod,leng0,fin)
        f1 = ssc(mod,leng1,fin)
        f2 = ssc(mod,leng0,fin)
        f3 = ssc(mod,leng1,fin)
        aj0 = ajs(mod,turns)
        with tab1:
            colfin1, colfin2 = st.columns(2)
            with colfin1:
